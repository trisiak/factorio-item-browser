...
- Item, recipe, technology and machine data comes from packs generated by the
  sibling fork
  [factorio-blueprint-editor](https://github.com/trisiak/factorio-blueprint-editor)'s
  exporter and published on its GitHub Pages site; packs from
  [FactorioLab](https://factoriolab.github.io/)'s published datasets are
  selectable alongside them.
...
- Runtime data is fetched from the sibling fork
  [factorio-blueprint-editor](https://github.com/trisiak/factorio-blueprint-editor)'s
  published packs (MIT-licensed tooling) and from
  [FactorioLab](https://factoriolab.github.io/)'s published packs (an
  MIT-licensed project). In both cases the underlying game data remains Wube's
  and the mod authors'.
